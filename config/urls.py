...
urlpatterns = [
    ...
    path('api/meta/categories', urs_views.api_meta_categories, name='api_meta_categories'),
    ...
    path('api/monitor/touch/', urs_views.api_monitor_touch, name='api_monitor_touch'),
    path('api/monitor/get/', urs_views.api_monitor_get, name='api_monitor_get'),
