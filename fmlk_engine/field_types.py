...
ALIASES: Dict[str, List[str]] = {
    ...
    "image": ["image", "img", "picture", "photo", "avatar"],
    "media": ["media", "video", "audio", "file_media", "attachment_media"],
...
TYPES: List[Dict] = [
    ...
    {"key": "image", "ar": "صورة", "en": "Image", "category": "traditional",
     "description": "صورة (رابط أو رفع ملف يُحفظ كنص) تُعرض مصغرة في الجداول والبطاقات.",
     "usage": "صورة الموظف أو شعار الشركة."},
    {"key": "media", "ar": "وسائط", "en": "Media", "category": "traditional",
     "description": "ملف وسائط (صورة/فيديو/صوت حسب الامتداد) يُعرض مشغلاً مناسباً.",
     "usage": "فيديو تعريفي أو مقطع صوتي مرفق بالسجل."},
    # ── 15 relational ──
